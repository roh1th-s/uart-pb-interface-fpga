...
#
# create_project.tcl: Tcl script for re-creating project 'uart_pb_interface'
#
# Generated by Vivado on Thu Nov 21 15:37:06 +0530 2024
...
set project_name "uart_pb_interface"
...
set files [list \
 "[file normalize "$origin_dir/uart_pb_interface.srcs/sources_1/new/D_ff.sv"]"\
 "[file normalize "$origin_dir/uart_pb_interface.srcs/sources_1/new/debouncer.sv"]"\
 "[file normalize "$origin_dir/uart_pb_interface.srcs/sources_1/new/detect_btn_up.sv"]"\
 "[file normalize "$origin_dir/uart_pb_interface.srcs/sources_1/new/slow_clock.sv"]"\
 "[file normalize "$origin_dir/uart_pb_interface.srcs/sources_1/new/transmitter.sv"]"\
 "[file normalize "$origin_dir/uart_pb_interface.srcs/sources_1/new/uart_pb_interface.sv"]"\
]
...
set file "new/uart_pb_interface.sv"
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "SystemVerilog" -objects $file_obj
set_property -name "is_enabled" -value "1" -objects $file_obj
set_property -name "is_global_include" -value "0" -objects $file_obj
...
set_property -name "top" -value "uart_pb_interface" -objects $obj
...
set file "[file normalize "$origin_dir/uart_pb_interface.srcs/constrs_1/new/uart_pb_interface.xdc"]"
set file_imported [import_files -fileset constrs_1 $file]
set file "new/uart_pb_interface.xdc"
...
# Import local files from the original project
set files [list \
 "[file normalize "$origin_dir/uart_pb_interface.srcs/sim_1/new/transmitter_tb.sv"]"\
]
...
set file "new/transmitter_tb.sv"
...
set_property -name "top" -value "transmitter_tb" -objects $obj
